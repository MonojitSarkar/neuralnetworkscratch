...
#best result at :::::
# list1 = [1,2,3,4,22,8,11,16,17,19,24,5,14,9,10,12,15,25,26,27,18,21]
#list1 = [1,2,3,4,22,8,11,16,17,19,24,5,14,9,10,12,15,25,26,27,18,21]
#New best result at :
#list1 = [1,22,3,4,5,6,8,9,11,12,13,14,16,17,18,19,20,23,24,25,26,27]
list1 = [1,2,3,4,5,6,8,9,11,12,13,14,16,17,18,19,22,23,24,25,26,27]
list2 = []
